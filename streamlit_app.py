...
cursor.execute('''CREATE TABLE IF NOT EXISTS courses (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, department_id INTEGER, fee REAL NOT NULL, FOREIGN KEY(department_id) REFERENCES departments(id))''')
...
# (Keep other pages like Departments, Teachers, Students as before with tabs)
...
# Keep Registration Form and other pages as before...
